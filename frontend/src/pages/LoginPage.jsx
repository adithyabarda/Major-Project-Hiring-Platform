  ...
  return (
    <div className="w-full h-screen flex justify-center items-center absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500">
      ...
      <div className="w-full max-w-5xl flex justify-between">
        ...
        <div className="w-1/3 p-6 space-y-4 rounded-xl bg-white shadow-2xl dark:bg-white dark:text-gray-800">
          ...
          <form noValidate="" action="" className="space-y-4">
            <div className="space-y-2 text-sm">
              <label htmlFor="recruiter-username" className="block dark:text-gray-600">Username</label>
              <input
                type="text"
            ...
            <div className="space-y-2 text-sm">
              <label htmlFor="recruiter-password" className="block dark:text-gray-600">Password</label>
              <input
                type="password"
            ...
            <button className="block w-40 p-2 text-center rounded-full dark:text-gray-50 dark:bg-violet-600">
              Recruiter Login
            </button>
            </div>
          </form>
        ...
        {/* Developer Form */}
        <div className="w-1/3 p-6 space-y-4 rounded-xl bg-white shadow-2xl dark:bg-white dark:text-gray-800">
          <h1 className="text-2xl font-bold text-center mb-4">Login as Developer</h1>
          <form noValidate="" action="" className="space-y-4">
            <div className="space-y-2 text-sm">
              <label htmlFor="developer-username" className="block dark:text-gray-600">Username</label>
              <input
                type="text"
            ...
            <div className="space-y-2 text-sm">
              <label htmlFor="developer-password" className="block dark:text-gray-600">Password</label>
              <input
                type="password"
