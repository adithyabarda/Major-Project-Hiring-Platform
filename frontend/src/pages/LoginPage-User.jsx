...
const LoginPageUser = () => {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500">
            ...
            <button type="submit" className="w-32 text-white py-2 rounded-full bg-violet-500 dark:bg-violet-500 hover:bg-violet-700">
              Developer Login
            </button>
            </div>
          </form>
          ...
          <p className="text-xs text-center dark:text-gray-600">
            ...
            <Link to="/Developersignup" className="underline dark:text-gray-800">
              Sign up
            </Link>
          </p>
        </div>
